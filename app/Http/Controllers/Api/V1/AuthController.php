...
class AuthController extends Controller
{
    ...
    public function refresh(Request $request) { $data=$request->validate(['refresh_token'=>'required|string']); return response()->json(['success'=>true,'data'=>$this->auth->refresh($data['refresh_token'])]); }
